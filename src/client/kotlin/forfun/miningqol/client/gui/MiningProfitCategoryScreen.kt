...
class MiningProfitCategoryScreen(private val parentScreen: Screen) : VexelScreen("Mining Profit Settings") {
    ...
    override fun afterInitialization() {
        ...
        mainPanel = Rectangle(
            ...
            .setSizing(550f, Size.Pixels, 520f, Size.Pixels)
            .childOf(window)
            .apply {
                dropShadow = true
                shadowBlur = 40f
        ...
        mainPanel.yConstraint = (mainPanel.screenHeight - 520f) / 2f
        ...
        Button("Set HUD Position", 0xFFFFFFFF.toInt(), fontSize = 16f)
            ...
            .setPositioning((mainPanel.width - 480f) / 2f, Pos.ParentPixels, 410f, Pos.ParentPixels)
        ...
        // Note about pristine slider
        Text("Note: Pristine chance slider not yet implemented - use Java screen", 0xFF666666.toInt(), 11f, false)
